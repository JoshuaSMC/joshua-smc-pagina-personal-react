  ...
  return (
    <section
      ...
      className="relative flex flex-col items-center justify-center text-center 
                min-h-[140vh] pt-[20vh] pb-[40vh] 
                bg-gradient-to-b from-black/40 via-black/70 to-black/90 
                backdrop-blur-md overflow-hidden md:px-6"
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 
                      gap-8 px-4 md:px-10 w-full max-w-6xl mt-10">
        {projects.map((project, index) => (
          <motion.div
            ...
            className="rounded-2xl overflow-hidden 
                       ...
                       bg-gradient-to-tr from-[#6a6050]/15 via-[#645d50]/30 to-[#6a6050]/10 
                       backdrop-blur p-6 
                       transition-all duration-500 
                       hover:-translate-y-3 hover:shadow-[0_0_40px_rgba(255,255,255,0.09)]"
          >
            <img
              src={project.image}
              alt={project.title}
